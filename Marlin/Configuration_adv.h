...
#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_4_DESC "Preheat for " PREHEAT_3_LABEL
  #define MAIN_MENU_ITEM_4_GCODE "M140 S" STRINGIFY(PREHEAT_3_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_3_TEMP_HOTEND)
  //#define MAIN_MENU_ITEM_4_CONFIRM

  #define MAIN_MENU_ITEM_5_DESC "Lower Bed to Bottom"
  #define MAIN_MENU_ITEM_5_GCODE "M140 S" STRINGIFY(PREHEAT_2_TEMP_BED) "G90\nG0 Z300"
  //#define MAIN_MENU_ITEM_5_CONFIRM

  #define MAIN_MENU_ITEM_6_DESC "Nozzle to Rear Right"

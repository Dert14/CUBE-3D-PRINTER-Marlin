...
#define STRING_CONFIG_H_AUTHOR "(Marcin Klimkiewicz SKR 2)" // Who made the changes.
#define CUSTOM_VERSION_FILE Version_X301.h // Path from the root directory (no quotes)
...
#define MACHINE_UUID "2fc76cb6-a0c1-4395-9ce0-3777ff0ae621"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  29.67,  29.67 }
    #define DEFAULT_Ki_LIST {   2.44,   2.44 }
    #define DEFAULT_Kd_LIST {  90.37,  90.37 }
  #else
    #define DEFAULT_Kp 29.67
    #define DEFAULT_Ki 2.44
    #define DEFAULT_Kd 90.37
  #endif
#endif // PIDTEMP
